...
// Include necessary headers for debugging.
#ifndef NDEBUG
  #include <iostream>
  #include "tdebug.h"
#endif
...
namespace TagLib {
  ...
  namespace EBML {
    //! Abbreviation for the basic integer type.
    typedef unsigned long long int ulli;

    //! The id of an EBML Void element.
    ...
    /*!
     * The ids of the elements, which are available in the header element
